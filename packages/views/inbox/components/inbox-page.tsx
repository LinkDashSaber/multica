  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      {/* Raven decision points carry an issue, so they land in the
          IssueDetail branch — mount the self-contained decision letter above
          it. One component handles gate, clarify, AND promotion (#31), so the
          inbox is a filtered view of the 待我处理 queue with identical actions. */}
      <InboxDecisionCard item={selected} wsId={wsId} />
